...
-- Ejemplos.
-- parse (symbol "abc") "abc que tal" -> [("abc"," que tal")]
-- parse (symbol "abc") "ab que tal" -> []
------------------------------
...
-- Ejemplos.
-- parse natural "123 hola que tal" -> [(123," hola que tal")]
--  parse natural "hola que tal" -> []
...
-- Ejemplos.
-- parse listnat "[1,2,3]" -> [([1,2,3],"")]
-- parse listnat "[1,2,3] hola que tal" -> [([1,2,3]," hola que tal")]
-- parse listnat "1,2,3 hola que tal" -> []